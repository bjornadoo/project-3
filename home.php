...
<div class="navbar">
  ...
  <div class="subnav">
    <button class="subnavbtn">Bjorn <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
      <a href="../project-3/bjorn/bjorn.html">Company</a>
      <a href="#team">Team</a>
  ...
  <div class="subnav">
    <button class="subnavbtn">abdifitah <i class="fa fa-caret-down"></i></button>
    <div class="subnav-content">
      <a href="../project-3/abdifatah/abdifatah.html">Link 1</a>
